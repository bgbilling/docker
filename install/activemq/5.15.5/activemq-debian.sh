...
[ ! -f /opt/activemq ] \
  ...
  && curl https://raw.githubusercontent.com/bgbilling/docker-base/master/install/activemq/activemq.xml -o $ACTIVEMQ_HOME/conf/activemq.xml \
  ...
  && curl https://raw.githubusercontent.com/bgbilling/docker-base/master/install/activemq/activemq.service -o /lib/systemd/system/activemq.service \
